...
<h4>Backend interface for <a href="https://arch14.cz">Arch14CZ - Czech Archaeological Radiocarbon Database</a></h4>
<p>Version %s (%s)</p>
...
<p><a href="https://github.com/ARUP-CAS/aiscr-arch14cz-backend">Home page</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="%s">Third party libraries</a></p>
