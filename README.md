...
<pre><code>git clone https://github.com/ARUP-CAS/aiscr-arch14cz-backend.git</code></pre>
5. The repository will be cloned to a new directory named `aiscr-arch14cz-backend` in your current directory.
6. Change into the newly created directory:
<pre><code>cd aiscr-arch14cz-backend</code></pre>
